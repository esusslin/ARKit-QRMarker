...
This test project is able to get an initial anchor near the marker and track it even if the marker is out of view. Also it updates the position of the object if the marker was moved. An inital anchor is a bottom left qorner of the QR mark. If you know a better solution for using qr marks in ARKit please let me know =)
